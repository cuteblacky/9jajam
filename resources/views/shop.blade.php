        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <table class="table table-striped table-responsive table-cart">
              ...
              <tbody>
                <tr>
                  <td><a href="#"><img src="https://res.cloudinary.com/ninejajam/image/upload/v1700182458/jollof%20rice.jpg"
                   alt=""> Jollof Rice & Suya Chicken</a> </td>
                  <td>$1,200 </td>
                  ...
                  <td><span class="total">$1,200 </span> <a class="pull-right" href="#"><i class="fa fa-times"></i></a></td>
                </tr>
                <tr>
                  <td><a href="#"><img src="https://res.cloudinary.com/ninejajam/image/upload/v1700159545/download_coconut_jqbvpd.jpg" alt=""> 
                  Fried Rice & Stew Chicken</a> </td>
                  <td>$1,200</td>
                  <td><!-- input group minus & plus-->
                    <div class="input-group plus-minus"> <span class="input-group-btn">
                ...
                <tr>
                  <td><a href="#"><img src="https://res.cloudinary.com/ninejajam/image/upload/v1700183212/eforiro_soup_lmnmbs.jpg" alt=""> Eforiro Soup & Fufu</a> </td>
                  <td>$1,700</td>
                  <td><!-- input group minus & plus-->
                    <div class="input-group plus-minus"> <span class="input-group-btn">
                    ...
                    <!-- End input group minus & plus --></td>
                  <td><span class="total">$1,700 </span> <a class="pull-right" href="#"><i class="fa fa-times"></i></a></td>
                </tr>
                <tr>
                  <td><a href="#"><img src="https://res.cloudinary.com/ninejajam/image/upload/v1631681720/Egusi_pix_chovru.png" alt=""> Egusi Soup & Fufu</a> </td>
                  <td>$2,500</td>
                  <td><!-- input group minus & plus-->
                    <div class="input-group plus-minus"> <span class="input-group-btn">
                    ...
                    <!-- End input group minus & plus --></td>
                  <td><span class="total">$2,500 </span> <a class="pull-right" href="#"><i class="fa fa-times"></i></a></td>
                </tr>
                <tr>
                  <td><a href="#"><img src="https://res.cloudinary.com/ninejajam/image/upload/v1700159501/okro_seafood_nigerian_food_1q-Food-platter-123-300x199_hemk4i.jpg" '
                  alt=""> Seafood Okro Soup & Fufu</a> </td>
                  <td>$2,500</td>
                  <td><!-- input group minus & plus-->
                    <div class="input-group plus-minus"> <span class="input-group-btn">
                  ...
                  <div class="form-group">
                    ...
                    <div class="select_wrap">
                      <select class="form-control">
                        <option value="one">Order Type</option>
                        <option value="one">Delivery</option>
                        <option value="two">Pick Up</option>
                        <!-- <option value="three">Curbside</option>
                    ...
                    <div class="select_wrap">
                      <select class="form-control">
                        <option value="one">Select Your Parish</option>
                        <option value="one">St James</option>
                    ...
                    <!-- <button type="submit" class="btn form-control btn-black">UPDATE ORDER</button> -->
