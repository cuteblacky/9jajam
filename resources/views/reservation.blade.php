...
<!-- Your Title Page
    ============================================= -->
<title>9jajam | Reservation</title>
<!-- Favicon Icons
     ============================================= -->
...
<li class="mega-menu"><a href="/menu">
  ...
  <div id="content">
      ...
      <div class="container date-blocks">
        <div class="row">
          <div class="col-md-3 col-sm-6 col-xs-12">
            <!-- Block item -->
            <div class="block-item"> <img src="img/breakfast_dark.png" alt="">
              <h2>LUNCH</h2>
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
            <!-- Block item -->
            <div class="block-item"> <img src="img/lunch_dark.png" alt="">
              <h2>DINNER</h2>
              <p>4:00 pm 7:00 pm</p>
            </div>
            <!-- End Block item -->
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
            <!-- Block item -->
            <div class="block-item"> <img src="img/dinner_dark.png" alt="">
              <h2>TAKE OUT</h2>
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
            <!-- Block item -->
            <div class="block-item"> <img src="img/dessert_dark.png" alt="">
              <h2>DELIVERY</h2>
              <small>(Only within Montego Bay)</small>
              <p>1:00 pm 6:00 pm</p>

              <div class="col">

              <img 
              src="https://res.cloudinary.com/ninejajam/image/upload/c_fit,h_250,w_100/v1700743636/image_2023-11-23_074710555_wls9yg.png" 
              alt="" >
              </div>
            </div>
            <!-- End Block item -->
                          ...
                          <div class="col-md-6 col-sm-6 col-sx-12">
                            ...
                            <div class="select_wrap">
                              <select class="form-control" name="occasion">
                                ...
                                <option value="d">Birthday Party</option>
                                <option value="two">Wedding</option>
                                <option value="three">Corporate</option>
                          ...
                          <div class="col-md-6 col-sm-6 col-sx-12">
                            ...
                            <div class="select_wrap">
                              <select class="form-control" name="food">
                                ...
                                <option value="d">Bulk Order</option>
                                <option value="two">Platter (Small Chops)</option>                                
    ...
    <section class="extra_touch padding-100 text-center">
      <div class="container">
        <div class="row">
          <h2>Come & <span>Experience</span> A Taste of Africa in Montego Bay</h2>
          <a href="/contact" class="btn black btn-gold ">GET IN TOUCH</a> </div>
      </div>
    </section>
    <!-- End extra touch -->
    <!-- Map 
