    ...
    <div class="container">
      <div class="row">
        ...
        <div id="logo"> <a href="/" class="light-logo"><img src="https://res.cloudinary.com/ninejajam/image/upload/v1624923380/White_Official_9jajam_Logo_New-02-01_a9nthj.png" alt="Logo"></a>
         <a href="/" 
         class="dark-logo"><img src="https://res.cloudinary.com/ninejajam/image/upload/v1624469296/Black_Official_9jajam_Logo_New_1-02_znrvh0.png" width="200px" alt="Logo"></a> </div>
        <!-- #logo end -->
        <!-- Primary Navigation
                    ============================================= -->
...
<li class="mega-menu"><a href="/menu">
            ...
            <div class="shop_cart_content">
              ...
              <div class="cart_items">
                ...
                <!-- <div class="item clearfix"> <a href="#"><img src="img/post_thumb3.jpg" alt=""></a>
                  <div class="item_desc"> <a href="menu_single.html">Food Name</a> <span class="itemff
 ...
 <!-- End shop cart -->
  ...
  <div id="content">
    <!-- Events  
    ============================================= -->
    <section  class="events padding-100 text-center">
      <div class="container">
        <div class="row">
          <p>We host occations from time to time, check out our calender to experience the next big thing.</p>
          <div id="calendar" class="mt40"></div>
        </div>
      </div>
    </section>
    <!-- End Events -->
...
<script src="javascripts/libs/fullcalendar.min.js" ></script>
<!-- JS Custom Codes -->
