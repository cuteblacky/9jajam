              ...
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-md-4 col-sm-4 col-sx-12">
                    <!-- Element -->
                    <div class="element">
                      <input type="text" name="website" class="form-control text" placeholder="Phone Number" />
                    </div>
                    <!-- End Element -->
                  </div>
                </div>
              ...
              <div class="row">
                ...
                <div class="col-md-4 adress">
                  ...
                  <div class="col-md-9 content-item">
                    <h3>Adress</h3>
                    <p> Unit #6 Bhavela Plaza, Ironshore  <br>
                      Montego Bay, St. James - Jamaica</p>
                  </div>
                  <!-- End content Item -->
                </div>
                <!--End Adress -->
                ...
                <div class="col-md-4 Phone">
                  ...
                  <div class="col-md-9 content-item">
                    <h3>PHONE</h3>
                    <p>Telephone:<span>+1 (876) 462-4255</span></p>
                ...
                <div class="col-md-4 email">
                  ...
                  <div class="col-md-9 content-item">
                    <h3>E-MAIL</h3>
                    <p>Support: <a href="mailto:admin@e-mail.com">info@9jajam.com</a></p>
...
<!-- End wrapper -->
<!-- Core JS Libraries -->
<script src="javascripts/libs/jquery.min.js" type="text/javascript">
  
</script>
<script src="javascripts/libs/plugins.js">
...
<!-- <script src="https://maps.googleapis.com/maps/api/js?key=&amp;sensor=false&amp;extension=.js"></script>-->
 ...
 <!-- JS Plugins -->
<script async
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAOxqjakvKjyXT8Lw3xzdBBo5KGMa_O0iE&callback=initMap">
</script>
